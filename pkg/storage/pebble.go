...
func (r remoteStorageAdaptor) CreateStorage(locator shared.Locator) (shared.Storage, error) {
...
func NewPebble(ctx context.Context, cfg PebbleConfig) (p *Pebble, err error) {
	...
	if cfg.RemoteStorageFactory != nil {
		opts.Experimental.SharedStorage = remoteStorageAdaptor{p: p, ctx: ctx, factory: cfg.RemoteStorageFactory}
	}
